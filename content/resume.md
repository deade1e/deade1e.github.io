...
C and Rust developer with **10+ years of experience**, specialized in
**low-level systems programming**, **malware analysis**, and **threat
intelligence**. Skilled in both offensive and defensive security, with
expertise ranging from red teaming tool development to SOC L3 incident
response.

[**Contributor to the Linux
kernel**](https://git.kernel.org/pub/scm/linux/kernel/git/efi/efi.git/commit/?id=4f90742d4a09a8253861b0d5fd0984e3cd399c9b),
author of a [Tor protocol re-implementation](https://github.com/deade1e/lor),
...
- Implemented various EDR/AV evasion techniques and payloads in <span
  class="skill">C</span> that were effective and helped different Red Team
  operations.
...
- Developed Light Onion Router, a <span class="skill">C</span> library that
  enables Tor connections without proxy. Used in different PoCs
- Spoke at the [Linux day 2015
  conference](https://web.archive.org/web/20260312231310/https://linuxday.orvietolinux.it/programma/)
...
- Performed malware analysis on samples coming from state-sponsored actors to
...
information retrieval.  Accepted and merged into mainline Linux  

[Lor - Light Onion Router](https://github.com/deade1e/lor) | October 2015 - January 2017 | 1 year 4 months  

Tor protocol client re-implementation using mbedTLS, demonstrating direct
hidden service connection without Tor binary  
...
Issued by Ministero dell'Istruzione - 2013
